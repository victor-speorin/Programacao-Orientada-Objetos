...
public class PrincipalLance {
    ...
    private final LanceService lanceService = FabricaDeServicos.getServico(LanceService.class);
    private final ProdutoService produtoService = FabricaDeServicos.getServico(ProdutoService.class);
